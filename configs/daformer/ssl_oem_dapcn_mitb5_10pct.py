# ---------------------------------------------------------------
# P1 / Table IX: DAPCN-SSL on OpenEarthMap @ 10% labeled
#
...
data = dict(
    train=dict(
        labeled=dict(split='train_10pct_labeled.txt'),
        unlabeled=dict(split='train_10pct_unlabeled.txt')))

name = 'ssl_oem_dapcn_mitb5_10pct'
name_dataset = 'openearthmap_ssl_10pct'
