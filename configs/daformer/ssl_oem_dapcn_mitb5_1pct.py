# ---------------------------------------------------------------
# P1 / Table IX: DAPCN-SSL on OpenEarthMap @ 1% labeled
#
...
data = dict(
    train=dict(
        labeled=dict(split='train_1pct_labeled.txt'),
        unlabeled=dict(split='train_1pct_unlabeled.txt')))

name = 'ssl_oem_dapcn_mitb5_1pct'
name_dataset = 'openearthmap_ssl_1pct'
