...
# DAPCN_SSL from the head channels (Solution 1: in_channels[-1]=512, with
# a learned proto_to_decoder Linear(512->64) bridge to conv_seg).
uda = dict(
    alpha=0.999,
...
name = 'ssl_oem_dapcn_unetformer_r18'
exp = 'ssl_oem'
