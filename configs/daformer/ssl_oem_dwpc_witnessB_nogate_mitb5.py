# ---------------------------------------------------------------
# DWPC ablation row A3 (SSL) — Witness B, no gate (~topology weighting)
...
name = 'ssl_oem_dwpc_witnessB_nogate_mitb5'
exp = 'ssl_oem_dwpc'
name_uda = 'dwpc_witnessB_nogate'
