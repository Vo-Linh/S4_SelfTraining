# ---------------------------------------------------------------
# SupOnly baseline: unetformer (ResNeXt101) on OpenEarthMap -- Table IX lower bound.
#
...
# ssl_oem_dapcn_unetformer_resnext101.py, so the gap between the two is exactly
...
name = 'sup_oem_unetformer_resnext101'
exp = 'sup_oem'
